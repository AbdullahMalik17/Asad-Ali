...
export default function Programs() {
  return (
    <section
      id="programs"
      className="relative overflow-hidden bg-[#fbf8f0] py-24"
    >
      {/* Decorative Islamic-style circles */}
      <div className="absolute -left-24 top-20 h-64 w-64 rounded-full border border-amber-300/30" />
      <div className="absolute -right-24 bottom-10 h-72 w-72 rounded-full border border-emerald-700/10" />
        ...
        <div className="mt-16 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {programs.map((program) => {
            ...
            return (
              <article
                key={program.title}
                className="group rounded-3xl border border-amber-200/70 bg-white p-7 text-center shadow-sm transition duration-300 hover:-translate-y-2 hover:border-amber-400 hover:shadow-xl"
              >
                <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-emerald-50 text-emerald-800 transition group-hover:bg-emerald-800 group-hover:text-white">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="mt-6 inline-flex font-bold text-amber-600 transition hover:text-emerald-800"
                >
                  Course Details →
                </a>
              </article>
